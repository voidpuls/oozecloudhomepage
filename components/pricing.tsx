...
export default function Pricing({ plans }: PricingProps) {
  return (
    <section className="py-16 relative bg-[#010901]">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-4">
                  <Link
                    ...
                    className={`block w-full text-center py-3 px-4 rounded-md transition-all duration-300 font-semibold ${
                      plan.popular
                        ? "bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-500 text-black"
