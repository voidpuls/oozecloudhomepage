...
export default function FAQ() {
  ...
  items: [
    ...
    {
      question:
        "What are the differences between shared, VPS, and dedicated Minecraft/Discord hosting?",
      answer: (
        <>
    ...
    {
      question:
        "What kind of support do you offer for Minecraft and Discord hosting?",
      answer: (
        <>
