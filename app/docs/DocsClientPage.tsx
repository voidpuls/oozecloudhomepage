        ...
        return (
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Welcome to Oozecloud documentation. This guide will help you get started with our hosting services and
              provide detailed information on how to make the most of our platform.
            </p>
            <p className="text-gray-300 mb-4">
              Oozecloud provides high-performance hosting solutions for various needs, including game servers, VPS
      ...
      case "quick-start":
        return (
          <section>
            ...
            <p className="text-gray-300 mb-4">Follow these steps to quickly set up your first server on Oozecloud:</p>
            <ol className="space-y-4 text-gray-300 list-decimal pl-5">
              <li>
                <strong className="text-white">Create an account</strong> - Sign up for a Oozecloud account if you
                haven't already.
              </li>
              <li>
            ...
            <div className="mt-6 p-4 bg-black/30 rounded-lg border border-green-500/20">
              <div className="flex justify-between items-center mb-2">
                ...
                <button
                  onClick={() =>
                    copyToClipboard(
                      `curl -X POST https://api.Oozecloud.com/servers \\
      ...
      case "account-setup":
        return (
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Setting up your account properly is essential for a smooth experience with Oozecloud. Here's how to
      ...
      case "game-setup":
        return (
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Setting up a game server with Oozecloud is quick and easy. Follow these steps to get your game server up
              and running.
            </p>
...
server-name=Oozecloud Minecraft Server
gamemode=survival
difficulty=normal
max-players=20
view-distance=10
      ...
      case "game-mods":
        return (
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Oozecloud makes it easy to install mods on your game server. Here's how:
            </p>

            <ol className="space-y-4 text-gray-300 list-decimal pl-5">
              <li>
                <strong className="text-white">Access your server control panel</strong> - Log in to your Oozecloud
    ...
    <div className="min-h-screen bg-[#010901] pt-16 pb-16">
      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto mb-8 text-center reveal">
          ...
          <h1 className="mb-4 text-3xl font-bold text-white md:text-4xl lg:text-5xl">Oozecloud Documentation</h1>
