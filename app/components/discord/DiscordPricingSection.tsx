        ...
        >
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-4">
            <div className="flex-1">
              <div className="inline-flex items-left gap-2 bg-green-100 dark:bg-green-600/20 px-4 py-2 rounded-full mb-4 border border-green-600/20 dark:border-green-400/20">
