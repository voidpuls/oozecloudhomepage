...
export const metadata = {
  title: "Contact Us - Oozecloud",
  description: "Get in touch with Oozecloud for sales inquiries, technical support, or general questions.",
}

export default function ContactPage() {
  return (
    <div className="min-h-screen bg-[#010901] pt-32 pb-16 relative">
      <SpaceBackground />
