...
export const metadata = {
  title: "Legal Information - Oozecloud",
  description: "Legal information, compliance, and policies for Oozecloud services.",
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-8 border rounded-lg border-green-500/20 bg-[#010901]/70 backdrop-blur-md space-y-6 text-gray-300">
            ...
            <section>
              ...
              <ul className="mt-4 space-y-4">
                <li>
                  ...
                  <p className="text-sm text-gray-400 mt-1">Our terms and conditions for using Oozecloud services.</p>
                </li>
                <li>
            ...
            <section>
              ...
              <p>Oozecloud is committed to complying with all applicable laws and regulations, including:</p>
            ...
            <section>
              ...
              <p>
                ...
                property of Oozecloud or its content suppliers and is protected by international copyright laws.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Oozecloud and the Oozecloud logo are trademarks of Oozecloud, Inc. All other trademarks,
