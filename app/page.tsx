                    ...
                    <Button
                      ...
                      className={
                        button.variant === "outline"
                          ? "border-green-500 text-green-400 hover:bg-green-500/10 transition-all duration-300 min-w-[140px]"
                          : "relative overflow-hidden group bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-500 text-black font-bold transition-all duration-300 shadow-[0_0_15px_rgba(16,185,129,0.5)] hover:shadow-[0_0_25px_rgba(16,185,129,0.7)] min-w-[140px]"
                      }
                      onClick={(e) => {
                        e.preventDefault()
